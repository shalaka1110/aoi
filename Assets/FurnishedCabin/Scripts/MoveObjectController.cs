...
public class MoveObjectController : MonoBehaviour 
{
	...
	private int rayLayerMask,rayLayerMask1; 
	...
	void Start()
	{
     ...
     //  LayerMask iRayLM = LayerMask.NameToLayer("PostProcessing");
        //Debug.Log(iRayLM);
	...
	{		
		if (playerEntered)
		{
           ...
           // Debug.Log("player entered");
			...
			if (Physics.Raycast(player.transform.position,player.transform.forward, out hit,reachRange,rayLayerMask))
			{
	...
	void OnGUI()
	{
		...
		{
			GUI.Label(new Rect (50,Screen.height - 150,200,50), msg,guiStyle);
		}
	}		
	//End of GUI Config --------------
	#endregion
